<x-layouts.app title="Tambah Dokter">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('dokters.index') }}" class="flex items-center justify-center w-9 h-9 rounded-lg bg-slate-100 text-slate-500 hover:bg-slate-200 transition">
        ...
        <div class="card-body p-7">
            <form action="{{ route('dokters.store') }}" method="POST">
                ...
                <div class="flex gap-3 mt-6">
                    ...
                    <a href="{{ route('dokters.index') }}" class="flex items-center gap-2 px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-lg text-sm font-semibold transition">
                        Batal
                    </a>
                </div>
            </form>
